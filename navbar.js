...
<header id="mainNavbar"
  ...
  <div class="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
      ...
      <ul class="flex items-center gap-10 font-medium text-sm" id="navLinks">
        ...
        <li class="relative">
          ...
          <ul id="homeDropdownMenu"
            class="absolute left-0 mt-3 w-44 bg-white text-[#EC4899] rounded-xl shadow-xl hidden z-50">
            <li><a href="index.html" class="block px-4 py-2 rounded-t-xl hover:bg-pink-100">Home 1</a></li>
            <li><a href="home2.html" class="block px-4 py-2 rounded-b-xl hover:bg-pink-100">Home 2</a></li>
          </ul>
        </li>
        ...
        <li class="relative">
          ...
          <ul id="dashboardDropdownMenu"
            class="absolute left-0 mt-3 w-40 bg-white text-[#EC4899] rounded-xl shadow-xl hidden z-50">
            <li><a href="user.html" class="block px-4 py-2 hover:bg-pink-100 rounded-t-xl">User</a></li>
            <li><a href="admin.html" class="block px-4 py-2 hover:bg-pink-100 rounded-b-xl">Admin</a></li>
          </ul>
        </li>
    ...
    <div id="rightButtons" class="hidden lg:flex items-center gap-8">
      ...
      <!-- RTL -->
      <button id="rtlToggle" class="text-2xl">⇄</button>
      ...
      <div class="relative">
        ...
        <ul id="profileMenu"
          class="absolute right-0 mt-3 w-44 bg-white text-[#EC4899] rounded-xl shadow-xl hidden z-50">
          <li><a href="login.html" class="block px-4 py-2 hover:bg-pink-100 rounded-t-xl">Login</a></li>
          <li><a href="sign.html" class="block px-4 py-2 hover:bg-pink-100 rounded-b-xl">Sign Up</a></li>
        </ul>
      </div>
...
<div id="mobileMenuOverlay"
  class="fixed inset-0 bg-pink-200  bg-opacity-60 hidden lg:hidden z-40"></div>

<!-- Mobile Menu -->
<div id="mobileMenu"
  class="fixed top-0 right-0 h-full w-72 bg-[#EC4899] text-white z-50
